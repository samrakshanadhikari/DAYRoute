...
**DayRoute: a weekly class-aware planner that uses time gaps, priority, and location to suggest what task to do next.**

Not just a to-do list. Not just navigation. The key idea is:

> "The app knows my weekly fixed schedule, knows today's date/day, finds free gaps between classes, and recommends the best tasks I can realistically complete based on time, priority, and location."

## Core Features To Build For Demo

### 1. Weekly Fixed Schedule

User enters classes for Monday-Friday.

Example:

- Monday: Class 9:00-10:15, Class 1:00-2:15
- Tuesday: Class 11:00-12:15
- Saturday/Sunday: free

The app should know today is Monday/Tuesday/etc. and only use that day's classes.
...
Is it high priority?
Is the task location close to current/next class?
...
- calculating travel time between current location, task location, and next class
- showing whether a task is realistic before the next class
...
> "The app tells the user what they can do between classes."
