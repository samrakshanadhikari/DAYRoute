...
const styles = StyleSheet.create({
  ...
  form: { backgroundColor: '#edf9f1', borderWidth: 1, borderColor: '#b9e4c8', borderRadius: 10, padding: 13, gap: 13 },
  formHint: { color: '#0f7a3b', fontSize: 12, fontWeight: '900' },
  inputLabel: { color: '#314158', fontSize: 11, fontWeight: '900', marginBottom: 3 },
  ...
  formRow: { flexDirection: 'row', gap: 9, flexWrap: 'wrap' },
  ...
  routeRow: { flexDirection: 'row', minHeight: 74, alignItems: 'stretch' },
  timeCol: { width: 58, alignItems: 'flex-end', paddingTop: 2, flexShrink: 0 },
  time: { color: '#071936', fontSize: 13, lineHeight: 17, fontWeight: '900', textAlign: 'right' },
  endTime: { color: '#7a8798', fontSize: 10, lineHeight: 14, marginTop: 3, textAlign: 'right' },
  rail: { width: 24, alignItems: 'center', flexShrink: 0 },
  ...
  routeCard: { flex: 1, minWidth: 0, backgroundColor: '#f8fbff', borderWidth: 1, borderColor: '#e1e9f5', borderRadius: 10, padding: 11, marginBottom: 10 },
